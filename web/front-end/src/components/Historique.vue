<template>
<div
class="flex flex-col items-center m-auto overflow-auto w-3/6 h-4/5"
>
...
const hisRdv = async () => {
    const response = await fetch("http://brief6.api/rdv/historique", {
    method: "POST",
...
const todayRdv = async () => {
    const response = await fetch("http://brief6.api/rdv/todayRdv", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(data.value),
    })
...
const futureRdv = async () => {
    const response = await fetch("http://brief6.api/rdv/futureRdv", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(data.value),
    })
...
const deleteRdv = async (id) => {
    let response = await fetch("http://brief6.api/rdv/removeRdv", {
    method: "POST",
