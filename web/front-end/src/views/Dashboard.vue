...
<div class="w-2/12 flex">
    ...
    to="/"
    @click="logOut"
    class="flex mx-auto mb-2 self-end border-2 border-purple-700 text-purple-700 p-2 hover:text-white hover:bg-purple-700"
    >Log Out</router-link
    >
</div>
...
const user = async () => {
    const response = await fetch("http://brief6.api/client/user", {
    method: "POST",
